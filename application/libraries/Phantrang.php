...
class Phantrang
{
	 ...
	 * không csdl
	 */
	function show_array($urls = array())
	{
		return array_slice($urls, $this->_config['start'], $this->_config['limit']);
	}
	...
	function html()
	{
		...
		{
			$p = '<ul class="pagination pagination-sm d-flex flex-wrap">';
			
			// Nút prev và first
			if ($this->_config['current_page'] > 1)
			{
				$p .= '<li class="page-item"><a class="page-link" href="' . $this->__link('1') . '">Đầu</a></li>';
				$p .= '<li class="page-item"><a class="page-link" href="' . $this->__link($this->_config['current_page'] - 1) . '">Trước</a></li>';
			}
			...
			if ($this->_config['current_page'] < $this->_config['total_page'])
			{
				$p .= '<li class="page-item"><a class="page-link" href="' . $this->__link($this->_config['current_page'] + 1) . '">Sau</a></li>';
				$p .= '<li class="page-item"><a class="page-link" href="' . $this->__link($this->_config['total_page']) . '">Cuối</a></li>';
			}
