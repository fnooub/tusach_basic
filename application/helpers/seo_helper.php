...
if(! function_exists('meta_tags')){
    function meta_tags($enable = array('general' => true, 'og'=> true, 'twitter'=> true, 'robot'=> true), $title = '', $desc = '', $imgurl ='', $url = '', $canonical = false){
        $CI =& get_instance();
        ...
        $output .= '<title>'.$title.' | Thư viện Tủ Sách</title>';
